...
const DropDownUser = () => {
    ...
    // state to determine whether dropdown is open or not
    const [dropdownOpen, setDropdownOpen] = useState(false);

    const router = useRouter();

    const user = useUser();//info of currently loggeed in user
    ...
    return (
        ...
        <div className="">
            ...
            onClick={() => setDropdownOpen(!dropdownOpen)}
                href={'#'} //preventing default behaviour of a link
                className="flex items-center gap-4"
            >

                <span className=" text-right lg:block">

                    {/* display username and job title */}
